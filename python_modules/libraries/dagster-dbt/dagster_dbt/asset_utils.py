...
def get_asset_spec(
    ...
    # base spec based off of default functions and user-defined functions
    ...
    spec = AssetSpec(
        ...
        owners=translator.get_owners(
            {
                **resource_props,
                # this overrides the group key in resource_props, which is bad, but
                # necessary for backcompat
